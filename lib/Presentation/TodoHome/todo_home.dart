...
import 'package:task_master/Presentation/TodoHome/screens/default_textfield.dart';
    ...
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:SvgPicture.asset(AssetsConstants.menu,)
                  )
                ],
              ),
              const Gap(10),
            ...
            Row(
              ...
              const Gap(16),
              Column(
                children: List.generate(4, (index) => const TaskTile()),
              )
            ],
          ),
        ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            SvgPicture.asset(AssetsConstants.hiIcon,color: Pallete.primaryColor, width: getSize(24), height: getSize(24),),
            SvgPicture.asset(AssetsConstants.calendar2, width: getSize(24), height: getSize(24),),
            CircleAvatar(
              backgroundColor: Pallete.primaryColor,
              radius: getSize(28),
              child: Icon(Icons.add, size: getSize(24),color: Colors.white,),
            ),
            SvgPicture.asset(AssetsConstants.chart, width: getSize(24), height: getSize(24),),
            SvgPicture.asset(AssetsConstants.profile, width: getSize(24), height: getSize(24),),
          ],
        ),
      )
    );
