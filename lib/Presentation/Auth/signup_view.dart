...
class _SignUpViewState extends State<SignUpView> {
  ...
  final confirmPasswwordController = TextEditingController();
  bool isChecked = true;
  @override
          ...
          child: Column(
            children: [
              ...
              DefaultField(
                  ...
                  controller: confirmPasswwordController),
              const Gap(12),
              DefaultField(
                  isPassword: true,
              ...
              DefaultButton(
                raduis: 10,
                btnTextContent: "Signup with Facebook",
                btnIcon: AssetsConstants.facebook,
              ),
              const Gap(10),
              DefaultButton(
                raduis: 10,
                btnTextContent: "Signup with Google",
